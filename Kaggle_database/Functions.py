...
# Méthode heuristique de détection spam basée sur proportion de mots spam, longueur du message, texte en majuscules
def is_spam_heuristic(email_text, spam_keywords):
    ...
    # Si beaucoup de mots spam (>20%), ou texte très court (<20 chars), ou texte en majuscules : spam
